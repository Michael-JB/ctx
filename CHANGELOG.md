...
## [0.1.0](https://github.com/Michael-JB/ctx/compare/ctx-tui-v1.0.4...ctx-tui-v0.1.0) (2026-08-30)


### ⚠ BREAKING CHANGES

* ctx now installs from crates.io or GitHub release binaries; existing PyPI installs stay on 1.0.4 and no longer receive updates.
* ctx claude-hook is gone. Update Claude Code hook configs to invoke ctx builtin claude status-hook instead.

### chore

* prepare first release ([b4f4859](https://github.com/Michael-JB/ctx/commit/b4f4859bf78a26b1986320c59e6666d4fc68b617))
...
* rewrite ctx in Rust ([884dfff](https://github.com/Michael-JB/ctx/commit/884dfff29723e5a2e0fd1b4fceae1b0951ff8579))
